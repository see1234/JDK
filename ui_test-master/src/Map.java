...
public class Map extends JPanel {
    ...
    public static final int MODE_WITH_BOT = 0;
    public static final int MODE_WITH_PLAYER = 1;
    ...
    private static final String MSG_WIN_HUMAN_ONE = "Победил первый игрок!";
    private static final String MSG_WIN_HUMAN_TWO = "Победил второй игрок!";
    ...
    private void update(MouseEvent mouseEvent) {
        ...
        if(MODE_WITH_BOT == mode) {

                field[y][x] = HUMAN_DOT;

        }
        else if(MODE_WITH_PLAYER == mode) {
            if (isX) {
                field[y][x] = HUMAN_DOT;
                isX=false;
            } else {
        ...
        switch (gameStateType){
            ...
            case STATE_WIN_HUMAN: {
                if(MODE_WITH_BOT == mode) {
                    ...
                    g.drawString(MSG_WIN_HUMAN_ONE, 30, getHeight() / 2 + 60);
                }
                break;
            }
            case STATE_WIN_AI: {
                ...
                if(MODE_WITH_BOT == mode) {
                    ...
                    g.drawString(MSG_WIN_HUMAN_TWO, 30, getHeight() / 2 + 60);
                }
                break;
            }
